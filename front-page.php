...
?>
<section id="hero" class="module module--hero">
	<div class="container">
		<div class="row">
...
<section id="featured" class="module">
   <div class="container">
   	    <h2 class="module__heading">Dale has been featured in<span class="dot animated">.</span><span class="dot animated">.</span><span class="dot animated">.</span></h2>

   	    <div class="image">
   	    	<img src="<?php echo bloginfo('template_url') ?>/assets/img/Media-Logos-Grey.png" alt="media logo" width="100%" class="media-logos animated"/>
   	    </div>
   </div>
</section>
...
<section id="featured-blogs" class="module">
	<div class="container">
		 ...
		 <div class="module__button">
		 	  <a href="#" class="module__button--link">Click Here to See More</a>
		 </div>
	</div>
</section>
