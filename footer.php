...
<footer class="site-footer">
 	 	...
 	 	<div class="signup-form signup-form--horizontal">
			<div class="container">
                 	...
                 	<h2 class="heading">Want <span class="module__heading--caps">Free</span> Help to Grow Your Business?</h2>
	       			<p  class="subheading">Subscribe now and receive free growth strategies delivered weekly</p>
